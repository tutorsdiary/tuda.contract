...
contract TokenERC20 {
     ...
     */
    function approveAndCall(address _spender, uint256 _value, bytes _extraData) validAddress public returns (bool success) {
     ...
     * @param _value the amount of money to burn
     */
    function burnFrom(address _from, uint256 _value) validAddress public returns (bool success) {
...
contract TudaToken is Sellable, Ownable, TokenERC20 {
    ...
    function mintToken(address target, uint256 mintedAmount) validAddress onlyOwner public {
        require (target != 0x0);
    ...
    function freezeAccount(address target, bool freeze) validAddress onlyOwner public {
        require (target != 0x0);
